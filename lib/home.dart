      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          activeIcon: Container(padding: const EdgeInsets.symmetric(vertical: 6,horizontal: 12),
              ...
              child: SvgPicture.asset("assets/icons/Vector.svg",colorFilter: const ColorFilter.mode(Colors.white, BlendMode.srcIn))),
          label: "quran"),
          BottomNavigationBarItem(icon: SvgPicture.asset("assets/icons/book-album-svgrepo-com 1.svg"),
          activeIcon: Container(padding: const EdgeInsets.symmetric(vertical: 6,horizontal: 12),
            decoration: BoxDecoration(color: Apptheme.black.withOpacity(0.5),borderRadius: BorderRadius.circular(66)),
            child: SvgPicture.asset("assets/icons/book-album-svgrepo-com 1.svg",colorFilter: const ColorFilter.mode(Colors.white, BlendMode.srcIn))),
          label: "hadeth"),
