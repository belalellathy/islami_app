            ...
            Container(
              ...
              child: FutureBuilder<Prayerresponsemodel>(
                  future: APIManager.getpraytime(
                      city: locationprovider.city ?? "cairo",
                      country: locationprovider.country ?? "egypt",
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                          ...
                          ElevatedButton(
                              onPressed: () {
                                APIManager.getpraytime(
                                    city: locationprovider.city ?? "cairo",
                                    country:
                                        locationprovider.country ?? "egypt",
                                    street: locationprovider.street ?? "");
                                setState(() {});
                              },
                      ...
                      String mogeo=data.data!.date!.gregorian!.month!.en!;

                      String editedmo = mo.substring(0, 3);
                      String editimogeo= mogeo.substring(0, 3);
